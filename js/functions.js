var functions = {
	...
	update() {
		...
		data.layer = data.totalA.gte(1e100) ? data.totalA.div(1e10).log10().log10().floor().add(1) : data.totalA.gte(1e10) ? data.totalA.log10().log10().floor().add(1) : data.totalA.log(1e10).floor().add(1);
