var functions = {
	...
	update() {
		...
		data.number = data.totalA.gte(Number.MAX_VALUE)
			? new Decimal(Number.MAX_VALUE).pow(data.totalA.log(Number.MAX_VALUE).log10().add(1.1**25).log(1.1).sub(data.totalA.log(Number.MAX_VALUE).log10().add(1.1**25).log(1.1).floor()).pow(3))
			: data.totalA;
		data.layer = data.totalA.gte(Number.MAX_VALUE) ? data.totalA.log(Number.MAX_VALUE).log10().add(1.1**25).log(1.1).floor().sub(23) : data.totalA.log(Number.MAX_VALUE).floor().add(1);
